---
home: true
title: DC.js - DarkCrystal 前端工具库
description: 一个功能丰富的纯前端工具库，为前端开发提供基础组件和工具类
---

<div class="hero">
  <div class="hero-content">
    <h1>DC.js</h1>
    <p>DarkCrystal 前端工具库</p>
    <p class="hero-description">
      一个功能丰富的纯前端工具库，为前端开发提供基础组件和工具类
    </p>
    <div class="hero-buttons">
      <a href="/dcjs库使用说明" class="btn-primary">快速开始</a>
      <a href="/utils/" class="btn-secondary">浏览工具类</a>
      <a href="/components/" class="btn-secondary">浏览组件</a>
    </div>
  </div>
</div>
...
<div class="features">
  <div class="feature">
    <h3>纯前端项目</h3>
    <p>不依赖任何后端服务，可直接集成到任何前端项目中</p>
  </div>
  <div class="feature">
    <h3>双版本支持</h3>
    <p>提供JavaScript和TypeScript两个版本，满足不同开发需求</p>
  </div>
  <div class="feature">
    <h3>全局注册</h3>
    <p>所有组件和工具类都注册到全局的window.DC对象下，使用方便</p>
  </div>
  <div class="feature">
    <h3>完整文档</h3>
    <p>包含完整的测试用例、示例代码和详细的说明文档</p>
  </div>
  <div class="feature">
    <h3>丰富功能</h3>
    <p>提供大量实用工具类和组件，覆盖前端开发常见需求</p>
  </div>
  <div class="feature">
    <h3>易于扩展</h3>
    <p>模块化设计，易于扩展和定制，满足项目特定需求</p>
  </div>
</div>
...
**详细文档：** [dcProgressBar](./components/dcprogressbar/dcProgressBar)
...
**详细文档：** [dcScreenshot](./utils/dcScreenshot)
