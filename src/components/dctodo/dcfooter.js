        ...
        <div class="footer-normal">
          ...
          <div class="privacy-and-copyright">
            <div class="links-privacy">
              <a href="#" title="服务条款">Terms of Service</a>
              <a href="#" title="隐私政策">Privacy Policy</a>
              <a href="#" title="cookies政策">Cookies Policy</a>
            </div>
            <div class="copyright">Copyright &copy; ${new Date().getFullYear()} All Rights Reserved by William.</div>
          </div>
        </div>
      </div>
    `;
