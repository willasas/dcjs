    ...
    img.onload = () => {
      ...
      if (ctx) {
        ...
        try {
          ...
          console.log(`%cImage: ${imageName} | Format: PNG | Dimensions: ${img.width}x${img.height} | Size: ${imageSize}`, `color: #fff; background:${color}; padding: 2px 10px; border-radius: 3px;`)
          console.log(
            `%c Preview`,
            `font-size: 1px;
