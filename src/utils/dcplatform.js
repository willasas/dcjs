...
class DCPlatform {
   ...
   */
  _detectTablet() {
    return /ipad|tablet/i.test(this.ua) || (this._detectAndroid() && !/mobile/i.test(this.ua))
  }
   ...
   */
  _detectIPad() {
    return /ipad/i.test(this.ua) || (/macintosh/i.test(this.ua) && 'ontouchend' in document)
  }
   ...
   */
  _detectIOS() {
    return /ipad|iphone|ipod/i.test(this.ua) || (/macintosh/i.test(this.ua) && 'ontouchend' in document)
  }
  ...
  isQQ() {
    return this._cache.isQQ
  }
  isWeChat() {
    return this._cache.isWeChat
  }
  isInGame() {
    return this._cache.isInGame
  }
  isWeChatMiniProgram() {
    return this._cache.isWeChatMiniProgram
  }
  isAlipayMiniProgram() {
    return this._cache.isAlipayMiniProgram
  }
  isQQMiniProgram() {
    return this._cache.isQQMiniProgram
  }
  isWebkit() {
    return this._cache.isWebkit
  }
  isOpera() {
    return this._cache.isOpera
  }
  isMozilla() {
    return this._cache.isMozilla
  }
  isChrome() {
  ...
  isQQApp() {
    return this._cache.isQQApp
  }
  isWeChatApp() {
    return this._cache.isWeChatApp
  }
  isQQMobileBrowser() {
    return this._cache.isQQMobileBrowser
  }
  isQQBrowser() {
    return this._cache.isQQBrowser
  }
  isIPad() {
    return this._cache.isIPad
  }
  isIPhone() {
    return this._cache.isIPhone
  }
  isIPod() {
    return this._cache.isIPod
  }
  isAndroid() {
