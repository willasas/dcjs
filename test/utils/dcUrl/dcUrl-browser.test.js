...
function runTests() {
  ...
  // 查询参数处理测试
  test('getQueryParams: 在浏览器环境下解析查询参数', () => {
  ...
  test('getQueryParams: 在浏览器环境下处理重复参数', () => {
  ...
  test('getQueryParams: 在浏览器环境下处理空查询字符串', () => {
  ...
  test('getQueryParams: 在浏览器环境下处理特殊字符', () => {
  ...
  // 参数添加和修改测试
  test('addQueryParam: 在浏览器环境下添加新参数', () => {
  ...
  test('addQueryParam: 在浏览器环境下修改现有参数', () => {
    const url = 'https://example.com/page?existing=value';
  ...
  test('addQueryParam: 在浏览器环境下处理特殊字符', () => {
    const url = 'https://example.com/page';
  ...
  test('build: 在浏览器环境下处理空部件对象', () => {
    const built = dcUrl.build({});
    
    return built === '';
  });

  test('build: 在浏览器环境下只有搜索参数', () => {
    const parts = {
      search: '?param=value'
    };
